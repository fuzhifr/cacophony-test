		...
		if(len!=0){
			...
			for(var i=0;i<len;i++){
				if(!data.button.rows[i].hasOwnProperty("time")){
					...
					buttonHtml+="Introduction："+data.button.rows[i].label+" <p>";
				}
			}
			 if(nChapitre!=0){
